  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button
          variant="outline"
          className="bg-gray-100 text-gray-500 text-lg py-5 rounded-none capitalize text-center w-full relative"
        >
          companies
          <svg
            viewBox="0 0 24 24"
            ...
            className="size-8 -scale-x-100 absolute right-2"
          >
      ...
      <SheetContent>
        <SheetHeader>
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="size-6 absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-slate-100 dark:ring-offset-slate-950 dark:focus:ring-slate-300 dark:data-[state=open]:bg-slate-800"
          >
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g
              id="SVGRepo_tracerCarrier"
